...
\r
${Buffer.from(buffer).toString("base64")}\r
--boundary--`
        });
...
async function sendEmail(email, fileLinks) {
  const emailTemplate = `
        ...
        <p>Aqu\xED est\xE1n los enlaces:</p>
        <ul>
...
// .wrangler/tmp/bundle-0H7tnH/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-0H7tnH/middleware-loader.entry.ts
